...
public class Level4Activity extends AppCompatActivity {
    ...
    public void number1(View v) {
        ...
        if (hairetu[seikai] == 1) {
            ...
            if (error == 5) {
                ...
                Intent intent = new Intent(Level4Activity.this, SubActivity.class);
    ...
    public void number4(View v) {
        ...
        if (hairetu[seikai] == 4) {
            ...
            if (error == 5) {
                Toast.makeText(this, "ゲームオーバー", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(Level4Activity.this, SubActivity.class); // どの画面からどの画面に遷移するか
